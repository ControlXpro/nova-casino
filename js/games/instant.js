...
const SC_CARDS = {
  ...
  'scratch-diamonds': { label: 'DIAMOND SCRATCH', chance: 0.132, prizes: [3, 8, 20, 60, 250, 1500],
    ...
    syms: ['💎', '💍', '🔷', '🔶', '✨', '👑', '🥇', '🪙'], top: 1500 },
  'scratch-royal': { label: 'ROYAL SCRATCH', chance: 0.16, prizes: [2.5, 7, 18, 55, 220, 1200],
    weights: [0.665, 0.225, 0.073, 0.027, 0.008, 0.002],
    syms: ['👑', '💎', '🏰', '🗝️', '⚜️', '🛡️', '🪙', '⭐'], top: 1200 },
  'scratch-emerald': { label: 'EMERALD SCRATCH', chance: 0.155, prizes: [2.5, 6, 15, 45, 180, 900],
    weights: [0.67, 0.22, 0.075, 0.026, 0.007, 0.002],
    syms: ['💚', '🍀', '💎', '🌿', '🐉', '👑', '🪙', '⭐'], top: 900 },
  'scratch-neon': { label: 'NEON SCRATCH', chance: 0.21, prizes: [1.8, 4, 9, 30, 120, 600],
    weights: [0.64, 0.24, 0.083, 0.028, 0.007, 0.002],
    syms: ['⚡', '🕹️', '💿', '🛸', '🌈', '🔮', '💜', '✨'], top: 600 },
  'scratch-pirate': { label: 'PIRATE SCRATCH', chance: 0.14, prizes: [3, 9, 25, 80, 300, 2000],
    weights: [0.66, 0.23, 0.07, 0.028, 0.009, 0.003],
    syms: ['🏴‍☠️', '⚓', '🦜', '🗺️', '💰', '⚔️', '💎', '🗝️'], top: 2000 },
...
export const instantGames = [
  ...
  G({ id: 'plinko-classic', name: 'Plinko Classic', cat: 'instant', icon: '🔻', art: 'linear-gradient(160deg,#1d2a52,#0b0d1c)', rtp: 99.0, vol: 'Medium', mount: plinko({ id: 'plinko-classic' }) }),
  G({ id: 'plinko-gold', name: 'Plinko Gold', cat: 'instant', icon: '🔺', art: 'linear-gradient(160deg,#4d3312,#0b0d1c)', rtp: 99.0, vol: 'High', mount: plinko({ id: 'plinko-gold', risk: 'high' }) }),
  G({ id: 'plinko-safe', name: 'Plinko Safe', cat: 'instant', icon: '🔻', art: 'linear-gradient(160deg,#123d33,#0b0d1c)', rtp: 99.0, vol: 'Low', mount: plinko({ id: 'plinko-safe', risk: 'low' }) }),
  ...
  G({ id: 'scratch-royal', name: 'Royal Scratch', cat: 'lottery', icon: '👑', art: 'linear-gradient(160deg,#3d1250,#0b0d1c)', rtp: 94.0, vol: 'High', mount: scratch({ id: 'scratch-royal' }) }),
  G({ id: 'plinko-mega', name: 'Plinko Mega', cat: 'instant', icon: '🔺', art: 'linear-gradient(160deg,#4d1250,#0b0d1c)', rtp: 99.0, vol: 'High', mount: plinko({ id: 'plinko-mega', risk: 'high' }) }),
  G({ id: 'plinko-turbo', name: 'Plinko Turbo', cat: 'instant', icon: '🔻', art: 'linear-gradient(160deg,#123d4d,#0b0d1c)', rtp: 99.0, vol: 'Medium', mount: plinko({ id: 'plinko-turbo' }) }),
  G({ id: 'scratch-emerald', name: 'Emerald Scratch', cat: 'lottery', icon: '💚', art: 'linear-gradient(160deg,#123d24,#0b0d1c)', rtp: 94.0, vol: 'High', mount: scratch({ id: 'scratch-emerald' }) }),
  G({ id: 'scratch-neon', name: 'Neon Scratch', cat: 'lottery', icon: '⚡', art: 'linear-gradient(160deg,#2a124d,#0b0d1c)', rtp: 94.0, vol: 'Medium', mount: scratch({ id: 'scratch-neon' }) }),
  G({ id: 'scratch-pirate', name: 'Pirate Scratch', cat: 'lottery', icon: '🏴‍☠️', art: 'linear-gradient(160deg,#123a4d,#0b0d1c)', rtp: 94.0, vol: 'High', mount: scratch({ id: 'scratch-pirate' }) }),
